...
//        self.view!.addGestureRecognizer(swipeLeftRec)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if (contact.bodyA.categoryBitMask == PhysicsCategory.bullet.rawValue && contact.bodyB.categoryBitMask == PhysicsCategory.enemy.rawValue) || (contact.bodyB.categoryBitMask == PhysicsCategory.bullet.rawValue && contact.bodyA.categoryBitMask == PhysicsCategory.enemy.rawValue) {
            print("Ouch!")
            boss.takeDamage()
            return
        }
