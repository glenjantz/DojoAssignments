...
//        bee2.position = CGPoint(x: 325, y: 325)
        bee2.position = CGPoint(x: self.size.width/2 + 50, y: self.size.height/2 + 150)

        self.addChild(bee2)
        let bee3 = Bee()
//        bee3.position = CGPoint(x: 200, y: 325)
         bee3.position = CGPoint(x: self.size.width/2 - 50, y: self.size.height/2 + 150)
        self.addChild(bee3)
        
        let staff1 = Staff()
//        staff1.position = CGPoint(x: 100, y: 325)
        staff1.position = CGPoint(x: self.size.width/2 - 200, y: self.size.height/2 + 150)
        self.addChild(staff1)
        
        let staff2 = Staff()
        staff2.texture = SKTextureAtlas(named:"Staff").textureNamed("staff2")
//        staff2.position = CGPoint(x: 50, y: 325)
        staff2.position = CGPoint(x: self.size.width/2 - 250, y: self.size.height/2 + 150)
        self.addChild(staff2)
        
        let staff3 = Staff()
        staff3.texture = SKTextureAtlas(named:"Staff").textureNamed("staff3")
//        staff3.position = CGPoint(x: -600, y: 325)
        staff3.position = CGPoint(x: self.size.width/2 - 800, y: self.size.height/2 + 150)
        self.addChild(staff3)
        
        let tree = Tree()
//        tree.position = CGPoint(x: 500, y: 220)
        tree.position = CGPoint(x: self.size.width - 100, y: (self.size.height/2 + ground.position.y + 15) )
        self.addChild(tree)
        
        let rock = Rock()
//        rock.position = CGPoint(x: -950, y: 140)
        rock.position = CGPoint(x: self.size.width/2 - 1050, y: (self.size.height/2 + ground.position.y)-50)
        self.addChild(rock)
...
//        player.position = initialPlayerPosition
        player.position = CGPoint(x:0, y:self.size.height - 180)
