...
class HUD: SKNode {
    ...
    func createHudNodes(screenSize:CGSize) {
        ...
        //Where do we position the restart button??
        menuButton.name = "returnToMenu"
//        menuButton.position = CGPoint(x: -140, y: 0)
        menuButton.position = CGPoint(x: -screenSize.width/2 + 140, y: 0)
        restartButton.size = CGSize(width: 140, height: 140)
        menuButton.size = CGSize(width: 70, height: 70)
        
        menuText.text = "Menu"
//        menuText.position = CGPoint(x: -140, y: -65)
        menuText.position = CGPoint(x: -screenSize.width/2 + 140, y: -screenSize.height/2 + 100 )
        menuText.fontSize = 28
        menuText.fontColor = SKColor.red
        
        restartText.text = "Restart"
//        restartText.position = CGPoint(x: 0, y: -100)
        restartText.position = CGPoint(x: 0, y: -screenSize.height/2 + 60)
        restartText.fontSize = 28
        restartText.fontColor = SKColor.red
        
        overText.text = "Game Over"
//        overText.position = CGPoint(x: -5, y: 140)
        overText.position = CGPoint(x: 0 , y: screenSize.height/2 - 60)
...
//        playerText2.position = CGPoint(x: -5, y: 130)
        playerText2.position = CGPoint(x: -5, y: screenSize.height/2 - (playerText.frame.maxY-2))
...
//        blood.position = CGPoint(x: 250, y: 180)
         blood.position = CGPoint(x: screenSize.width/2 - 50, y: screenSize.height/2 - 20)
    }
