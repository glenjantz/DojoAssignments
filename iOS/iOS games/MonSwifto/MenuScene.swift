...
//        logoText.position = CGPoint(x: 0, y: 100)
        logoText.position = CGPoint(x: 0, y: self.size.height/2 - 60)
        ...
        logoTextBottom.position = CGPoint(x: 0, y: self.size.height/2 - 120)
...
//        startButton.position = CGPoint(x: 0, y: -30)
        startButton.position = CGPoint(x: 0, y: self.size.height/2 - 200)
        ...
        ///????????how does startbutton text follow start button?????
