...
//            }
            else if nodeTouched.name == "C3" {
                
                self.run(C3Sound)
            }
            else if nodeTouched.name == "CS" {
                self.run(CsSound)
            }
            else if nodeTouched.name == "D" {
                self.run(DSound)
            }
            else if nodeTouched.name == "DS" {
                self.run(DsSound)
            }
            else if nodeTouched.name == "E" {
                self.run(ESound)
            }
            else if nodeTouched.name == "F" {
                self.run(FSound)
            }
            else if nodeTouched.name == "FS" {
                self.run(FsSound)
            }
            else if nodeTouched.name == "G" {
                self.run(GSound)
            }
            else if nodeTouched.name == "GS" {
                self.run(GsSound)
            }
            else if nodeTouched.name == "A" {
                self.run(ASound)
            }
            else if nodeTouched.name == "AS" {
                self.run(AsSound)
            }
            else if nodeTouched.name == "B" {
                self.run(BSound)
            }
            else if nodeTouched.name == "C4" {
                self.run(C4Sound)
            }
        }
        }
