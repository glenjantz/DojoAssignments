#PUBLIC INHERITANCE - methods that can be called within the class, subclasses and instances without restriction.
...
#PROTECTED INHERITANCE - methods that can only be called within the class and subclasses either explicitly or implicitly
...
# person.calling_speak

#PRIVATE INHERITANCE  - methods that can only be called within the class and subclasses implicitly
class Mammal
  def calling_cry
    cry
  end
